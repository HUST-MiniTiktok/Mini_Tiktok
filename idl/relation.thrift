...
struct FriendUser {
    ...
    13: optional i64 msgType            // message消息的类型，0 => 当前请求用户接收的消息， 1 => 当前请求用户发送的消息
}
...
service RelationService {
    RelationActionResponse RelationAction(RelationActionRequest request)
    RelationFollowListResponse RelationFollowList(RelationFollowListRequest request)
    RelationFollowerListResponse RelationFollowerList(RelationFollowerListRequest request)
    RelationFriendListResponse RelationFriendList(RelationFriendListRequest request)
}