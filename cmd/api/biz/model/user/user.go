...
type CheckUserIsExistResponse struct {
	StatusCode int32   `thrift:"status_code,1" json:"status_code" form:"status_code" query:"status_code"`
	StatusMsg  *string `thrift:"status_msg,2,optional" form:"status_msg" json:"status_msg,omitempty" query:"status_msg"`
	IsExist    bool    `thrift:"is_exist,3" form:"is_exist" json:"is_exist" query:"is_exist"`
}
...
type UserServiceCheckUserIsExistArgs struct {
	Request *CheckUserIsExistRequest `thrift:"request,1"`
}
...
type UserServiceCheckUserIsExistResult struct {
	Success *CheckUserIsExistResponse `thrift:"success,0,optional"`
}
